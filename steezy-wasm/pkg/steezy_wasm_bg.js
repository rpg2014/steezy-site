import * as wasm from './steezy_wasm_bg.wasm';
...
/**
*/
export class CalcuationEngine {

    static __wrap(ptr) {
        const obj = Object.create(CalcuationEngine.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_calcuationengine_free(ptr);
    }
    /**
    * @param {any[]} rules
    * @param {any[]} rule_scalings
    * @param {any[]} seasons
    * @returns {CalcuationEngine}
    */
    static new(rules, rule_scalings, seasons) {
        var ptr0 = passArrayJsValueToWasm0(rules, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        var ptr1 = passArrayJsValueToWasm0(rule_scalings, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        var ptr2 = passArrayJsValueToWasm0(seasons, wasm.__wbindgen_malloc);
        var len2 = WASM_VECTOR_LEN;
        var ret = wasm.calcuationengine_new(ptr0, len0, ptr1, len1, ptr2, len2);
        return CalcuationEngine.__wrap(ret);
    }
    /**
    * @returns {any[]}
    */
    get_rule_ids() {
        try {
            ...
            wasm.calcuationengine_get_rule_ids(retptr, this.ptr);
...
export function __wbg_alert_6b92b2c310ebdba2(arg0, arg1) {
